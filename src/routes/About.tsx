    ...
    <>
      ...
      <Container maxWidth="xl" sx={{ pt:5 }}>
        ...
        <Typography variant="body1" sx={{ mt:2 }}>
          ...
          for the current year. The goal this app is to emulate the result you get when you 
          search "UFC this weekend" on Google. The app is built using React and Material-UI for the frontend
          and .Net for the backend. The reason this app was made was for me to get practice developing a full stack application 
          and has nothing to do with the UFC.
        </Typography>
